...
export class PromptsManager {
  ...
  public async internalShowCategorySlidedown(options?: AutoPromptOptions): Promise<void> {
    ...
    const categorySlidedownOptions = PromptsHelper.getSlidedownPromptOptionsWithType(
              ...
              case DelayedPromptType.Sms:
                case DelayedPromptType.SmsAndEmail:
                  ...
                  const options = PromptsHelper
                    .getSlidedownPromptOptionsWithType(userConfig.promptOptions?.slidedown?.prompts || [], type);
                  return {
                    enabled: !!options,
