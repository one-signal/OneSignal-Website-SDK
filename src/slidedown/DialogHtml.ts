    ...
    return `
        <div id="normal-slidedown">
            <div class="slidedown-body" id="slidedown-body">
                ...
                <div class="clearfix"/>
                <div id="onesignal-loading-container"/>
            </div>
            <div class="slidedown-footer" id="slidedown-footer">
                <button id="onesignal-slidedown-allow-button" class="align-right primary slidedown-button">${positiveButtonText}</button>
                <button id="onesignal-slidedown-cancel-button" class="align-right secondary slidedown-button">${negativeButtonText}</button>
                <div class="clearfix"/>
            </div>
        </div>`;
}
